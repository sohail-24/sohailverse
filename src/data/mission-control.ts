...
export const initialProjects: UniverseProject[] = [
  {
    id: "sohail-shop",
    name: "Sohail-Shop",
    tagline: "Production-Grade E-Commerce & Multi-Cluster Cloud Architecture",
    description:
      "Production-grade Django ecommerce platform deployed across Docker, EC2, kubeadm Kubernetes, AWS EKS, Terraform, GitHub Actions and ArgoCD.",
    status: "live",
  ...
  },
  {
    id: "sohail-studio",
    name: "Sohail-Studio",
    tagline: "Creative Digital Studio & Interface Engineering Surface",
  ...
  },
  {
    id: "fresh-flow",
    name: "Fresh Flow",
    tagline: "Cloud Automation, Streamlined Workflows & Pipeline Engine",
    description: "Project details coming soon.",
    status: "building",
    statusLabel: "In Development",
    featured: false,
...
export const worldGateways: WorldGateway[] = [
  {
    id: "gateway-devops",
    title: "DevOps",
    description: "Cloud platforms, Kubernetes orchestrations, Terraform infrastructure, and GitOps CI/CD systems.",
  ...
  },
  {
    id: "gateway-atlas",
    title: "Atlas",
    description: "Interactive travel routes, destination logs, and cities mapped across continents.",
  ...
  },
  {
    id: "gateway-cinema",
    title: "Cinema",
    description: "Curated observatory of films, cinematic scores, storytelling crafts, and reviews.",
  ...
  },
  {
    id: "gateway-academy",
    title: "Academy",
    description: "Knowledge graph of cloud architecture, system design, certifications, and technical mastery.",
  ...
  },
  {
    id: "gateway-timeline",
    title: "Timeline",
    description: "The complete chronological narrative connecting life chapters, career shifts, and personal milestones.",
    metricLabel: "Journey chapters",
