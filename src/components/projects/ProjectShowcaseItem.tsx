...
import { resolveVersionedProjectImageUrl, prefetchProjectDetails } from "../../lib/projectContent";
      ...
      <div className="flex-1 min-w-0 flex flex-col justify-between self-stretch">
          ...
          {project.liveUrl && (
            <div className="pt-0.5">
              <div className="group/link inline-flex items-center gap-1.5 text-xs sm:text-sm font-mono text-cyan-400/90 group-hover:text-cyan-300 transition-colors">
                ...
                <span className="truncate underline underline-offset-4 decoration-cyan-400/30 group-hover:decoration-cyan-300 max-w-[170px] sm:max-w-none">
        ...
        <div className="mt-3.5 min-[400px]:mt-4 sm:mt-5 pt-2.5 min-[400px]:pt-3 sm:pt-4 border-t border-white/[0.08]">
          <span
            ...
            className="inline-flex w-full sm:w-auto min-h-[38px] min-[400px]:min-h-[40px] sm:min-h-[44px] items-center justify-center gap-2 rounded-xl bg-blue-600 group-hover:bg-blue-500 hover:bg-blue-500 text-white font-semibold px-4 sm:px-5 py-2 text-xs sm:text-sm transition-all duration-200 shadow-[0_0_18px_rgba(37,99,235,0.35)] group-hover:shadow-[0_0_24px_rgba(37,99,235,0.45)] hover:shadow-[0_0_24px_rgba(37,99,235,0.45)] active:scale-[0.98]"
          >
    ...
    >
      {isInternal ? (
        <Link
          ...
          className="block w-full focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 rounded-2xl cursor-pointer text-left"
        >
          {cardContent}
        </Link>
      ) : (
